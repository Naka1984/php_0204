...
<form action="userdata.php" method="post" class="User-Form">
    <div class="Form">
        <div class="Form-Item">
            ...
            <input type="text" class="Form-Item-Input" placeholder="例）手話　太郎" name="user_name"  autocomplete="name" required autofocus>
        </div>
    
    
        <div class="Form-Item">
            <p class="Form-Item-Label"><span class="Form-Item-Label-Required">必須</span>性別</p>
            <select name="sex" class="Form-Item-Input" required autofocus>
        ...
        <div class="Form-Item">
            ...
            <input type="date" class="Form-Item-Input" name="calendar" max="9999-12-31" required autofocus>
        </div>

        <div class="Form-Item">
            <p class="Form-Item-Label"><span class="Form-Item-Label-Required">必須</span>都道府県</p>
            <select name="pref" class="Form-Item-Input" required autofocus>
                <option value="" selected>選択してください</option>
        ...
        <div class="Form-Item">
            ...
            <input type="user_address" name="user_address" class="Form-Item-Input" placeholder="例）〇〇市△△町×丁目×-×" required autofocus>
        </div>


        <div class="Form-Item">
            <p class="Form-Item-Label"><span class="Form-Item-Label-Required">必須</span>FAX番号</p>
            <input type="fax_number" name="fax_number" class="Form-Item-Input" placeholder="例）000-0000-0000" required autofocus>
        </div>
        <div class="Form-Item">
            <p class="Form-Item-Label"><span class="Form-Item-Label-Required">必須</span>メールアドレス</p>
            <input type="email" name="email" class="Form-Item-Input" placeholder="例）example@gmail.com" autocomplete="email" required autofocus>
        </div>
        <!-- <div class="Form-Item">
